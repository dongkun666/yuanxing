...
2. **产品经理 / 律师顾问** → `02-target-users.md` + `03-core-steps.md` + `04-cross-cutting.md` + `08-roadmap.md`
3. **全栈工程师** → `06-architecture.md` + `07-data-security.md` + `tracks/*.md` (按 Track 接任务)
4. **UI 设计师** → `02-target-users.md` + `03-core-steps.md` + `04-cross-cutting.md`
5. **AI / RAG 工程师** → `05-knowledge-base.md` + `04-cross-cutting.md` § 5.4 Skill Hub + § 5.5 AI 对话 + `06-architecture.md`
6. **数据工程师** → `06-architecture.md` § 7.7 数据原则 + `04-cross-cutting.md` § 5.7 类案大数据
