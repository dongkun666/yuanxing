...
(function () {
    ...
    function searchZhixing() {
        ...
        setTimeout(function () {
            ...
            tbody.innerHTML = filtered
                .map(function (item) {
                    return (
                        '<tr class="hover:bg-bg-subtle transition-colors cursor-pointer" onclick="openZhixingDetail(\'' +
                        escapeHtml(item.caseNum) +
                        '\')">' +
                        '<td class="py-3 px-4 text-xs font-mono text-fg-primary">' +
                        escapeHtml(item.caseNum) +
                        '</td>' +
                        ...
                        '</td>' +
                        '<td class="py-3 px-4 text-xs text-fg-tertiary">' +
    ...
    function openZhixingDetail(caseNum) {
        ...
        var idLabel =
            (item.name && item.name.indexOf('公司') >= 0) || item.name.indexOf('有限') >= 0
                ? '统一社会信用代码'
                : '身份证号';
        ...
        var content =
            ...
            '</div>' +
            '<div class="p-3 bg-white border border-bg-border rounded-lg">' +
            '<p class="text-[11px] text-fg-tertiary mb-1">' +
            idLabel +
            '</p>' +
